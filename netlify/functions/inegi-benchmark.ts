 ...
 * INEGI Benchmark API
 * 
 * Endpoint: GET /.netlify/functions/inegi-benchmark?ocupacion={sinco_code}&entidad={ent_code}
 * 
 * Query params:
...
const handler: Handler = async (event) => {
  ...
  try {
    ...
    const queryOcupacion = event.queryStringParameters?.ocupacion;
    const queryEntidad = event.queryStringParameters?.entidad;
